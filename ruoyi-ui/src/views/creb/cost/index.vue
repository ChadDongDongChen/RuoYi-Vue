<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="costList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="发生日期" align="center" prop="costDate" width="180">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="成本金额" prop="costAmount">
          <el-input v-model="form.costAmount" placeholder="请输入成本金额" />
        </el-form-item>
        <el-form-item label="发生日期" prop="costDate">
          <el-date-picker clearable
...
<script>
import { listCost, getCost, delCost, addCost, updateCost } from "@/api/creb/cost"
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getCost(recordId).then(response => {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除养殖成本记录编号为"' + recordIds + '"的数据项？').then(function() {
        return delCost(recordIds)
      }).then(() => {
        this.getList()
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('creb/cost/export', {
        ...this.queryParams
